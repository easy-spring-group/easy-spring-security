...
public class WeChatConnectionFactory extends OAuth2ConnectionFactory<WeChat> {
     ...
     *
     * @author summer
     * @date 2019-01-25 17:58
     * @param accessGrant 微信的授权访问器
     * @return org.springframework.social.connect.Connection<com.bcdbook.security.social.api.WeChat>
     * @version V1.0.0-RELEASE
     */
    @Override
     ...
     * @return org.springframework.social.connect.ApiAdapter<com.bcdbook.security.social.api.WeChat>
     * @version V1.0.0-RELEASE
     */
     ...
     * @author summer
     * @date 2019-01-25 18:03
     * @return org.springframework.social.oauth2.OAuth2ServiceProvider<com.bcdbook.security.social.api.WeChat>
     * @version V1.0.0-RELEASE
     */
